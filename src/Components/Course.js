...
const Course = () => {
    ...
    return (
        <div className='bg-gray-200'>
            <h2 className='container  mx-auto rounded-lg text-slate-500 text-center text-4xl font-semibold my-4 glass bg-gray-300 py-5 border border-0'>Choose the Skill you want be expert</h2>

...
const Footer = () => {
    return (
        <div >
            <footer className="footer fixed bottom-0 items-center p-4 bg-gray-300 text-black-content">
